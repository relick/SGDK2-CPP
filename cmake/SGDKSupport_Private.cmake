...
function(SGDK_ext_out_dir target extension)
  ...
  get_target_property(target_gen_prefix ${target} SGDK_GENERATED_PREFIX)
  if(NOT target_gen_prefix)
    set(target_gen_prefix ${target})
  endif()
  set(target_${out_dir_var_name} ${${out_dir_var_name}}/${target_gen_prefix})
