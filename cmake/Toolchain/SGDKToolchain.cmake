...
set(SGDK_TOOLCHAIN_CMAKE_DIR ${CMAKE_CURRENT_LIST_DIR})
cmake_path(GET SGDK_TOOLCHAIN_CMAKE_DIR PARENT_PATH SGDK_DIR)

include("${SGDK_TOOLCHAIN_CMAKE_DIR}/SGDKToolchainGNU.cmake")
include("${SGDK_TOOLCHAIN_CMAKE_DIR}/SGDKToolchainClang.cmake")
...
if(EXISTS "${SGDK_DIR}/SGDKFindSGDKPaths.cmake")
  include("${SGDK_DIR}/SGDKFindSGDKPaths.cmake")
else()
  # Assume if this CMake file is missing, that this must be a source folder rather than install.
  cmake_path(GET SGDK_DIR PARENT_PATH SGDK_SOURCE_ROOT)
  
  set(SGDK_BIN ${SGDK_SOURCE_ROOT}/bin)
  set(SGDK_LINKER_SCRIPT ${SGDK_SOURCE_ROOT}/md.ld)
  set(SGDK_BOOTFILES ${SGDK_SOURCE_ROOT}/boot)

  set(SGDK_CMAKE_SUPPORT ${SGDK_SOURCE_ROOT}/cmake/Support)
endif()
...
if(CMAKE_HOST_WIN32)
  ...
  if(EXISTS "${SGDK_DIR}/SGDKFindWindowsToolchain.cmake")
    include("${SGDK_DIR}/SGDKFindWindowsToolchain.cmake")
    if(NOT EXISTS ${SGDK_WIN32_TOOLCHAIN})
      message(FATAL_ERROR "Win32 gcc toolchain could not be found at ${SGDK_WIN32_TOOLCHAIN} (set by ${SGDK_DIR}/SGDKFindWindowsToolchain.cmake)")
    endif()
  else()
    # Must be SGDK source if that file does not yet exist
    set(SGDK_WIN32_TOOLCHAIN ${SGDK_SOURCE_ROOT}/${SGDK_WIN32_TOOLCHAIN_RELATIVE})
  endif()
