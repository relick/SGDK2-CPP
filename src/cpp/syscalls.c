...
void    _exit  (int n)                             { for (;;); }
int     kill   (int n, int m)                      { return -1; }
int     getpid (int n)                             { return 1; }
caddr_t sbrk   (int nbytes)                        { return (caddr_t)0; }
int     fstat  (int file, struct stat * st)        { return -1; }
int     link   (void)                              { return -1; }
int     unlink (void)                              { return -1; }
clock_t times  (struct tms * tp)                   { return (clock_t) - 1; }
