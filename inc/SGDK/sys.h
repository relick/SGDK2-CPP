...
#endif
#else
#define main(...) sgdk_main(__VA_ARGS__)
#endif
...
typedef struct
{
    char console[16]       __attribute__((nonstring));    /* Console Name (16) */
    char copyright[16]     __attribute__((nonstring));    /* Copyright Information (16) */
    char title_local[48]   __attribute__((nonstring));    /* Domestic Name (48) */
    char title_int[48]     __attribute__((nonstring));    /* Overseas Name (48) */
    char serial[14]        __attribute__((nonstring));    /* Serial Number (2, 12) */
    u16 checksum;                                         /* Checksum (2) */
    char IOSupport[16]     __attribute__((nonstring));    /* I/O Support (16) */
